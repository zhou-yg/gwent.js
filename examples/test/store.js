...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_symbol_observable__ = __webpack_require__(14);
    ...
    return function (next) {
      return function (action) {
        ...
        if (action.from === 'browser') {
          ...
          socket.emit(action.type, (0, _stringify2.default)(action));
...
var reducer = (_reducer = {}, (0, _defineProperty3.default)(_reducer, types.TEST, function (state, a) {
  return state + a.value;
}), (0, _defineProperty3.default)(_reducer, types.TEST2, function (state, a) {
  return state - a.value;
}), _reducer);
...
var reducers = __webpack_require__(13);

var actionRouter = __webpack_require__(12);

module.exports = function createMyStore(socket) {

  socket.on('testx', function (m) {
    console.log(m);
  });

  var store = createStore(combineReducers({
    value: reducers
  }), applyMiddleware(actionRouter(socket)));
